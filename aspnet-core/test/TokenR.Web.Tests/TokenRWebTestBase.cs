...
{
    public abstract class TokenRWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TokenRWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TokenRWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TokenRDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TokenRDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TokenRDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TokenRDbContext, Task<T>> func)
        {
            T result;
